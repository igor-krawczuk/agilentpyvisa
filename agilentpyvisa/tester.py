...
class B1500():
    ...
    def setup_channel(self, channel):
        ...
        if channel.measurement is not None:
            return self.setup_measurement(channel.number, channel.measurement)
        if channel.dcforce is not None:
            ...
            return self.highspeed_spot_setup(channel.number, channel.highspeed_spot)
    ...
    def setup_measurement(self, channel_number, measurement):
        self._device.query(
            "MM {},{}".format(
                measurement.mode,
                channel_number))  # connect channel
        # connects or disconnects 1MOhm series
        self._device.query("CMM {},{}".format(channel_number, measurement.side))
